...
@REM set HFS=C:\Program Files\Side Effects Software\Houdini 18.5.499
set HFS=C:\Program Files\Side Effects Software\Houdini 19.5.605
...
@REM set MSVCDir=C:/Program Files (x86)/Microsoft Visual Studio/2019/Community/VC/Tools/MSVC/14.16.27023
set MSVCDir=C:/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Tools/MSVC/14.29.30133
